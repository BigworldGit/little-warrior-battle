...
generate_image("A high quality seamless texture of stylized hand-painted fantasy grass, vibrant green, Studio Ghibli style, top-down view, 2D game asset", "ground.png")
generate_image("A high quality seamless texture of stylized hand-painted stone paving, ancient ruins, fantasy style, top-down view, 2D game asset", "stone.png")
